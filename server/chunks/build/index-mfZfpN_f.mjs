  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentView.value === "Latest News") {
        _push(`<div class="articles-section"><h2>News</h2>`);
        if (sortedArticles.value.length > 0) {
          ...
          _push(`</div><div class="featured-article-text"><span class="article-category">${ssrInterpolate(sortedArticles.value[0].category)}</span><h3>${ssrInterpolate(sortedArticles.value[0].title)}</h3><p>${ssrInterpolate(sortedArticles.value[0].excerpt)}</p><div class="article-meta"><div class="author-info">`);
        ...
        _push(`<h2>Latest Article</h2><div class="article-grid"><!--[-->`);
        ssrRenderList(paginatedArticles.value, (article) => {
          ...
          _push(`</div><div class="article-content"><span class="article-category">${ssrInterpolate(article.category)}</span><h3>${ssrInterpolate(article.title)}</h3><p class="excerpt">${ssrInterpolate(article.excerpt)}</p><div class="article-footer"><span class="article-date">${ssrInterpolate(formatDate(article.date))}</span><span class="read-more"> Read more `);
...
//# sourceMappingURL=index-mfZfpN_f.mjs.map
