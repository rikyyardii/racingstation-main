...
import { u as useRuntimeConfig, _ as _imports_0, b as useRouter } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoDescription = computed(() => articleContent.value);
    useSeoMeta({
      title: seoTitle,
      ogTitle: seoTitle,
...
//# sourceMappingURL=_id_-CoZFc5Tm.mjs.map
