...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><article class="article-container"><h2>Website Disclaimer</h2><p>Last updated: February 15, 2025</p><p> The information provided by RacingStation (&#39;we&#39;, &#39;us&#39;, or &#39;our&#39;) on <a style="${ssrRenderStyle({ "color": "blue" })}" href="https://racingstation.top/" target="_blank">RacingStation Website</a> (the &#39;Site&#39;)\xA0is for general informational purposes only. All information on <span style="${ssrRenderStyle({ "font-size": "15px" })}">`);
...
//# sourceMappingURL=disclaimer-Mw8H2OQ1.mjs.map
