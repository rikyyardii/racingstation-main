...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`THE SITE`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      _push(`</span>  </span>OR RELIANCE ON ANY INFORMATION PROVIDED ON <span style="${ssrRenderStyle({ "font-size": "15px" })}"><span style="${ssrRenderStyle({ "font-size": "15px" })}"><span style="${ssrRenderStyle({ "font-size": "15px" })}">`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      _push(`THE SITE`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      ...
      _push(`THE SITE`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      _push(`</span></span>  </span>AND YOUR RELIANCE ON ANY INFORMATION ON <span style="${ssrRenderStyle({ "font-size": "15px" })}"><span style="${ssrRenderStyle({ "font-size": "15px" })}"><span style="${ssrRenderStyle({ "font-size": "15px" })}">`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      _push(`THE SITE`);
      _push(ssrRenderComponent(_component_bdt, { class: "block-component" }, null, _parent));
      _push(` </span></span></span>IS SOLELY AT YOUR OWN RISK. </p></article></main>`);
...
//# sourceMappingURL=disclaimer.vue.mjs.map
