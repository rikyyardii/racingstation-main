...
import { u as useRuntimeConfig, a as _imports_0 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span>${ssrInterpolate(articleRead.value)} min read</span></div></div><div class="rich-content">${articleContent.value ?? ""}</div></div></article><div class="adsterra-container"></div></main>`);
