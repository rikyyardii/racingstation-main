...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: "RacingStation",
      ogTitle: "RacingStation",
      description: "Get the latest sports news and live sports streaming include F1, MotoGP, WEC, Football, and other sports with a mobile-friendly display and stable steaming in RacingStation",
      ogDescription: "Get the latest sports news and live sports streaming include F1, MotoGP, WEC, Football, and other sports with a mobile-friendly display and stable steaming in RacingStation"
    });
    const getLink = (item) => {
      switch (item) {
        case "Latest News":
...
//# sourceMappingURL=index-4o1bL14W.mjs.map
