...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    name: "stream",
    path: "/stream",
    component: () => import('./stream.vue.mjs')
  },
  {
    name: "about-tos",
    path: "/about/tos",
  ...
  },
  {
    ...
    component: () => import('./disclaimer.vue.mjs')
  },
  {
    name: "about-contact-page",
    path: "/about/contact-page",
    component: () => import('./contact-page.vue.mjs')
  },
  {
    name: "about-racingstation",
    path: "/about/racingstation",
    component: () => import('./racingstation.vue.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./Ads.vue.mjs')
  },
  {
    name: "watch-offline_screen",
    path: "/watch/offline_screen",
    component: () => import('./offline_screen.vue.mjs')
  },
  {
...
const google_analytics_lrm3I53WsO0ABX8Fm__s73K_1pDMd_DELasTPvMc8TI = defineNuxtPlugin(() => {
});
...
const plugins = [
  ...
  google_analytics_lrm3I53WsO0ABX8Fm__s73K_1pDMd_DELasTPvMc8TI
];
...
const _imports_0 = "" + __buildAssetsURL("logo.BWaCgwa0.png");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-container" }, _attrs))} data-v-26c4567e><div class="spiral-background" data-v-26c4567e></div><div class="content" data-v-26c4567e><div class="logo-container animate-fade-in" data-v-26c4567e><img${ssrRenderAttr("src", _imports_0)} alt="Racing Station Logo" class="logo animate-float" data-v-26c4567e></div><h1 class="animate-slide-up" data-v-26c4567e>${ssrInterpolate(__props.error.statusCode)}</h1><h2 class="animate-slide-up animation-delay-1" data-v-26c4567e>${ssrInterpolate(__props.error.message)}</h2><p class="animate-slide-up animation-delay-2" data-v-26c4567e>Looks like we&#39;ve taken a wrong turn on the track!</p>`);
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-26c4567e"]]);
...
export { _export_sfc as _, _imports_0 as a, __nuxt_component_0 as b, useRouter as c, useRoute as d, server as s, tryUseNuxtApp as t, useRuntimeConfig as u };
