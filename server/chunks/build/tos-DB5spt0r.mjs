...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: "Terms and Conditions - RacingStation",
      ogTitle: "Terms and Conditions - RacingStation"
    });
    const getLink = (item) => {
      switch (item) {
        case "Latest News":
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/about/tos.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tos-DB5spt0r.mjs.map
