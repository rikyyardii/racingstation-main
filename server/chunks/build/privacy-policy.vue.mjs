...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: "Privacy Policy - RacingStation",
      ogTitle: "Privacy Policy - RacingStation"
    });
    const getLink = (item) => {
      switch (item) {
        case "Latest News":
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/about/privacy-policy.vue");
